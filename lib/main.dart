...
class BusinessDetailPage extends StatelessWidget{
 ...
 @override Widget build(BuildContext context){final img=v('image'),web=v('website'),phone=v('phone'),content=v('content');final raw=item is Map?(item['hours']??item['opening_hours']):null;final hours=raw is Map?raw:<dynamic,dynamic>{};const days={'monday':'Maandag','tuesday':'Dinsdag','wednesday':'Woensdag','thursday':'Donderdag','friday':'Vrijdag','saturday':'Zaterdag','sunday':'Zondag'};final hourRows=<Widget>[];
