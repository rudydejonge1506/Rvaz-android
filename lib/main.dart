...
class AppAdCard extends StatefulWidget {
  final AppAd ad;
  const _LegacyAppAdCard({super.key, required this.ad});
...
class _LegacyAppAdCard extends StatelessWidget {
  final AppAd ad;
